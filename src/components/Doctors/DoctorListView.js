...
class DoctorListView extends Component {
    ...
    const listviewdata = doctorlist.map(each=>{
    ...
    return (
        <div className='col-xl-3 col-12 order-xl-first  order-last me-2 bg-white shadow-sm rounded ' >
            ...
            <div className="input-group mt-5 mb-3 input-group-sm  px-2 py-1 border  " style={{borderRadius:'3.125rem'}} >
                <input type="search" className="form-control border-0" placeholder="Doctor List" aria-label="Patient List" aria-describedby="inputGroup-sizing-sm"
