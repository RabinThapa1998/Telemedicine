const OnboardingThree = () => {
    ...
    return (
        <div className='container-fluid bg-white shadow-sm fw-bold p-2 cp-fontsizemediaquery' style={{ fontSize: '12px', boxSizing: 'border-box' }}>
            <form action="">
                ...
                <div className="row m-0 p-3" style={{ backgroundColor: '#F9F8F8' }}>
                    ...
                    <div className="bg-white shadow-sm rounded m-0 p-2 row">
                        <div className="col m-2">
                            <div className='row d-flex flex-column my-2'>
                ...
                <div className="row my-2 " style={{whiteSpace:'nowrap'}}>
                    <div className='d-flex flex-row'>
                      <label for='furtherreferto' className='fw-bold fs-5'>Further Refer to &nbsp;</label>
                        <select className="form-select form-select-sm " aria-label=".form-select-sm example" id='furtherreferto' style={{width:'300px'}}>
